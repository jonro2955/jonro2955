...
Thanks for visiting my GitHub page! I am an aspiring full stack web developer based in Metro Vancouver, British Columbia, Canada. I began learning web and application development after deciding to completely commit myself to a skill. Being a self taught developer isn't easy, but the fulfillment I receive from crafting a piece of code, website, or system that simply works makes it easy for me to stick with it. I'm looking for any opportunity to round out my skills and broaden my horizons.
